...
FIELD_ORDERS = {
    "INT0095E": [
        # INT0095E v3: Worker_Sub-Type renamed to Worker_Sub_Type (INT0095E)
        "Employee_ID", "Transaction_WID", "Transaction_Effective_Date",
        "Transaction_Entry_Date", "Transaction_Type", "Position_ID",
        "Effective_Date", "Worker_Type", "Worker_Sub_Type", "Business_Title",
    ...
    "INT6031": [
        # INT6031 v3: Worker_ID first (PK), new Address_Line_1/2, fixed field order
        # Postal code typo fixed (Home_Addres → Home_Address), INDIGENOUS duplicate removed
        "Worker_ID", "Worker_Workday_ID", "Bank_of_the_West_Employee_ID",
        "Date_of_Birth", "Enterprise_ID", "Race_Ethnicity", "Gender",
        "Gender_Identity", "Indigenous", "Address_Line_1", "Address_Line_2",
        "Home_Address_City", "Home_Address_Country", "HOME_ADDRESS_COUNTRY_NAME",
        "Home_Address_Region", "HOME_ADDRESS_REGION_NAME",
        "Home_Address_Postal_Code", "Last_Name", "Legal_First_Name",
        "Legal_Full_Name", "Legal_Full_Name_Formatted", "Military_Status",
        "Preferred_First_Name", "Preferred_Full_Name",
        "Preferred_Full_Name_Formatted", "Primary_Work_Email_Address",
        "Secondary_Work_Email_Address", "Sexual_Orientation",
...
class TransactionalDataWriter:
    ...
    def _event_to_095e(self, e: EmployeeEvent) -> Dict:
        ...
        return {
            ...
            "Worker_Sub_Type": e.worker_sub_type,  # INT0095E v3: renamed from Worker_Sub-Type
    ...
    def _profile_to_6031(self, p: EmployeeProfile) -> Dict:
        """Convert an EmployeeProfile to an INT6031 row (v3: new field order, Address_Line_1/2 added)."""
        return {
            # INT6031 v3: Worker_ID is PK (first), Worker_Workday_ID second
            ...
            "Home_Address_Postal_Code": p.home_address_postal_code,  # v3: typo fixed
            ...
            # INT6031 v3: INDIGENOUS duplicate removed
        }
