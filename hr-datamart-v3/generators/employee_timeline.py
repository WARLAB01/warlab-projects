...
class EmployeeProfile:
    ...
    address_line_1: str  # INT6031 v3: new field
    address_line_2: str  # INT6031 v3: new field
    military_status: str
...
class EmployeeTimelineGenerator:
    ...
    def _gen_profile(self, emp_id: str, worker_wid: str, hire_date: datetime.date,
        ...
        profile = EmployeeProfile(
            ...
            address_line_1=f"{self.rng.randint(1, 9999)} {faker.street_name()}",  # INT6031 v3
            address_line_2=self.rng.choice(["", "", f"Apt {self.rng.randint(1, 999)}", f"Unit {self.rng.randint(1, 99)}", ""]),  # INT6031 v3
