"""
config.py - Master configuration for WARLab HR Datamart V3 synthetic data generation.

V3 changes from V2:
  - Seed changed to 42 (per deployment standard)
  - Feed timestamp updated to 20260323060000
  - OUTPUT_DIR changed to 'data'
  - CR1: INT6021 field order updated (no config change - handled in reference_data.py)
  - CR2: INT6022 normalized schema (no config change - handled in reference_data.py)
  - CR3: INT6027 Matrix_Organization_Description added
...
CALENDAR_END = datetime.date(2030, 12, 31)
...
MATRIX_ORGS = [
    {"id": "MORG_DIG_XFORM", "name": "Digital Transformation", "code": "DT", "type": "Project", "subtype": "Strategic", "status": "Active",
     "description": "Cross-functional initiative to modernize core banking systems and digitize client-facing workflows across all business lines."},
    {"id": "MORG_ESG", "name": "ESG & Sustainability", "code": "ESG", "type": "Committee", "subtype": "Governance", "status": "Active",
     "description": "Governance body overseeing environmental, social, and governance commitments including carbon neutrality and responsible investing standards."},
    {"id": "MORG_DEI", "name": "Diversity Equity & Inclusion", "code": "DEI", "type": "Committee", "subtype": "Cultural", "status": "Active",
     "description": "Employee-led committee driving programs for diverse hiring, equitable promotion practices, and inclusive workplace culture."},
    {"id": "MORG_INNOV", "name": "Innovation Lab", "code": "INN", "type": "Project", "subtype": "Strategic", "status": "Active",
     "description": "Dedicated incubator for piloting emerging financial technologies including blockchain, open banking APIs, and AI-driven advisory tools."},
    {"id": "MORG_DATA_GOV", "name": "Data Governance Council", "code": "DGC", "type": "Committee", "subtype": "Governance", "status": "Active",
     "description": "Enterprise council responsible for data quality standards, data lineage tracking, and compliance with privacy regulations across jurisdictions."},
    {"id": "MORG_CX", "name": "Client Experience", "code": "CX", "type": "Project", "subtype": "Strategic", "status": "Active",
     "description": "Program focused on improving end-to-end client journeys across retail, wealth, and institutional segments using journey mapping and NPS metrics."},
    {"id": "MORG_CLOUD", "name": "Cloud Migration", "code": "CLD", "type": "Project", "subtype": "Technology", "status": "Active",
     "description": "Multi-year initiative to migrate on-premises infrastructure to cloud platforms including AWS and Azure, targeting full migration by 2027."},
    {"id": "MORG_REG_CHG", "name": "Regulatory Change", "code": "REG", "type": "Project", "subtype": "Compliance", "status": "Active",
     "description": "Cross-divisional project managing adoption of new capital adequacy rules, AML directives, and cross-border reporting obligations."},
    {"id": "MORG_MA", "name": "M&A Integration", "code": "MA", "type": "Project", "subtype": "Strategic", "status": "Active",
     "description": "Integration management office coordinating people, process, and technology streams following acquisition of regional advisory firm."},
    {"id": "MORG_TALENT", "name": "Talent Strategy", "code": "TAL", "type": "Committee", "subtype": "HR", "status": "Active",
     "description": "Leadership committee defining five-year workforce planning model, succession pipelines, and retention programs for critical roles."},
    {"id": "MORG_AI_ML", "name": "AI & Machine Learning", "code": "AI", "type": "Project", "subtype": "Technology", "status": "Active",
     "description": "Centre of excellence for deploying machine learning models in credit scoring, fraud detection, and robo-advisory product development."},
    {"id": "MORG_COST_OPT", "name": "Cost Optimization", "code": "COT", "type": "Project", "subtype": "Finance", "status": "Active",
     "description": "Finance-led program identifying $150M in operational savings through vendor renegotiation, process automation, and real estate consolidation."},
    {"id": "MORG_CYBER", "name": "Cybersecurity Task Force", "code": "CYB", "type": "Committee", "subtype": "Technology", "status": "Active",
     "description": "Executive task force overseeing threat intelligence sharing, incident response readiness, and zero-trust architecture implementation."},
    {"id": "MORG_WM_STRAT", "name": "Wealth Management Strategy", "code": "WMS", "type": "Project", "subtype": "Business", "status": "Active",
     "description": "Strategic review of wealth management product suite, fee structures, and advisor compensation models to improve AUM growth trajectory."},
    {"id": "MORG_US_EXPAN", "name": "US Expansion", "code": "USE", "type": "Project", "subtype": "Strategic", "status": "Active",
     "description": "Market entry program supporting growth of US advisory and capital markets operations with regulatory licensing and local talent acquisition."},
]
...
ANNUAL_COMP_CHANGE_RATE = 0.85
AVG_ANNUAL_RAISE_PCT = 0.035
RAISE_STD_DEV = 0.015

LOA_ANNUAL_RATE = 0.04
AVG_LOA_DAYS = 90
